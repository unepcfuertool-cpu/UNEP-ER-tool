...
def render_general_info():
    ...
    with st.container(border=True):
        ...
        with col_act_1:
            ...
            st.checkbox("Cogeneration", value=False, key="act_energy_4")
            st.divider()
            st.markdown("**Afforestation & Restauration**")
            st.checkbox("Small, medium and large-scale agroforestry", value=False, key="act_arr_1")
            st.checkbox("Large-scale forest plantations", value=False, key="act_arr_2")
            st.checkbox("Natural regeneration", value=False, key="act_arr_3")
        with col_act_2:
            st.markdown("**Agriculture**")
            st.checkbox("Deforestation-free outgrower", value=False, key="act_agri_1")
            st.checkbox("Agro-industrial expansion", value=False, key="act_agri_2")
            st.checkbox("Sustainable intensification", value=False, key="act_agri_3")
            st.divider()
            st.markdown("**Forestry & Conservation**")
            st.checkbox("Forest Concessions Transitioning to Reduced Impact Logging", value=False, key="act_forest_1")
